...
while (continuar) {
  let entrada = prompt("Introduce un número de DNI (entre 0 y 99999999):");
  ...
  if (entrada === null) {
    ...
    if (numero >= 0 && numero <= 99999999) {
      ...
      alert("La letra correspondiente al número de DNI ingresado es: " + letra);
    } else {
      alert("El número debe estar entre 0 y 99999999.");
    }
  }
}
document.writeln("Calculador de letras de DNI finalizado.");
